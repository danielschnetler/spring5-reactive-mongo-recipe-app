...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
  ...
  public void onApplicationEvent(ContextRefreshedEvent event) {
    ...
    log.error("################# UOM Count " 
        + unitOfMeasureReactiveRepository.count().block().toString());
    log.error("################# Recipe Count " 
        + recipeReactiveRepository.count().block().toString());
    log.error("################# Category Count "
        + categoryReactiveRepository.count().block().toString());
  }
